                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        @if($blog->user_id === Auth::id())
                            <div class="btn-group">
                                <a href="{{ route('guide.blogs.edit', $blog->slug) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteBlogModal">
                                    <i class="fas fa-trash"></i> Delete
                                </button>
                                <form id="toggle-status-form-{{ $blog->id }}" action="{{ route('guide.blogs.update-status', $blog->slug) }}" method="POST" class="d-none">
                                    @csrf
                                    @method('PATCH')
                                </form>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            @if($blog->category)
                                <div>
                                    ...
                                    <a href="{{ route('guide.blogs.index', ['category' => $blog->category]) }}" class="badge bg-light text-dark text-decoration-none">
                                        {{ $blog->category }}
                                    </a>
                                </div>
                            @endif
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('guide.blogs.show', $blog->slug)) }}" 
                                   target="_blank" class="btn btn-sm btn-outline-primary">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('guide.blogs.show', $blog->slug)) }}&text={{ urlencode($blog->title) }}" 
                                   target="_blank" class="btn btn-sm btn-outline-info">
                                    <i class="fab fa-twitter"></i>
                                </a>
                                <button class="btn btn-sm btn-outline-secondary" onclick="copyToClipboard('{{ route('guide.blogs.show', $blog->slug) }}')">
                            ...
                            @foreach($relatedBlogs as $relatedBlog)
                                <div class="col-md-4 mb-3">
                                    <div class="card h-100 border-0 shadow-sm related-post">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <a href="{{ route('guide.blogs.show', $relatedBlog->slug) }}" class="text-decoration-none text-dark">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm">
                            ...
                            <li class="list-group-item">
                                <div class="row g-0">
                                    ...
                                    <div class="col-9 ps-3">
                                        <a href="{{ route('guide.blogs.show', $latestBlog->slug) }}" class="text-decoration-none">
                ...
                <div class="card-footer bg-white text-center">
                    <a href="{{ route('guide.blogs.index') }}" class="btn btn-sm btn-outline-primary">View All Posts</a>
                </div>
            </div>
        </div>
    </div>
