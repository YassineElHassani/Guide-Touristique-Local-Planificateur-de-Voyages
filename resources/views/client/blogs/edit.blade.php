        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('client.blogs.update', $blog->slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($blog->image)
                                    <div class="mt-2">
                                        <img id="imagePreview" src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" class="preview-image">
                                    </div>
                                @else
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted">A brief summary of your blog post (max 500 characters). If left empty, it will be generated from your content.</small>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="published" name="published" {{ old('published', $blog->published) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="published">Published</label>
                                        </div>
                                        <small class="form-text text-muted">If unchecked, the blog will be saved as a draft</small>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="featured" name="featured" {{ old('featured', $blog->featured) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="featured">Featured</label>
                                        </div>
                                        <small class="form-text text-muted">Featured blogs appear in the showcase carousel</small>
                                    </div>
                                </div>
                            </div>
                        </div>
