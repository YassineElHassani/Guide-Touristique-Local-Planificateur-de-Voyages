                    ...
                    <div class="col-md-8">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('client.reservations') }}">Reservations</a></li>
                        ...
                        <div class="card-body">
                            ...
                            @if($reservation->event)
                                @if($reservation->event->image)
                                    <img src="{{ asset('storage/' . $reservation->event->image) }}" class="event-image w-100 mb-4" alt="{{ $reservation->event->name }}">
                                @else
                                    <div class="event-image w-100 mb-4 bg-light d-flex justify-content-center align-items-center">
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">The event details for this reservation are no longer available.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="timeline">
                                <div class="timeline-item">
                                    <div class="timeline-icon {{ $reservation->created_at ? 'confirmed' : '' }}"></div>
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-icon {{ $reservation->status == 'confirmed' ? 'confirmed' : 'pending' }}"></div>
                                    <div class="timeline-content">
                                        <h6 class="mb-1">
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-icon {{ $reservation->status == 'cancelled' ? 'cancelled' : 'pending' }}"></div>
                                    <div class="timeline-content">
                                        <h6 class="mb-1">
                    ...
                    <div class="card detail-card">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                @if($reservation->event)
                                    <a href="{{ route('client.events.show', $reservation->event->id) }}" class="btn btn-outline-primary">
                                ...
                                @if($reservation->status === 'confirmed' && $reservation->event && $reservation->date >= now())
                                    <a href="#" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#contactGuideModal">
                                        <i class="fas fa-comment-alt me-2"></i> Contact Guide
                                    </a>
                                @endif
                                
                                <a href="{{ route('client.reservations') }}" class="btn btn-outline-secondary">
                    ...
                    @if($reservation->status === 'confirmed' && $reservation->event && $reservation->date < now())
                        <div class="card detail-card mt-4">
                            <div class="card-body">
                                ...
                                <p class="text-muted small mb-3">Share your thoughts about this event to help other travelers.</p>
                                
                                <a href="{{ route('client.reviews.create', ['event_id' => $reservation->event->id]) }}" class="btn btn-success w-100">
