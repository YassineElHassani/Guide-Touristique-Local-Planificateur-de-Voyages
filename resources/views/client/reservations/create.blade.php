            ...
            <div class="row g-4">
                ...
                <div class="col-md-7">
                    <div class="card detail-card">
                        @if($event->image)
                            <img src="{{ asset('storage/' . $event->image) }}" class="event-image card-img-top" alt="{{ $event->name }}">
                        @else
                            <div class="event-image card-img-top bg-light d-flex justify-content-center align-items-center">
                    ...
                    <div class="form-card p-4">
                        ...
                        <form action="{{ route('client.reservations.store', $event->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <small class="text-muted">The event is scheduled for {{ $event->date->format('F d, Y') }}</small>
                            </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span>Date:</span>
                                            <span class="fw-medium" id="selectedDateDisplay">{{ $event->date->format('M d, Y') }}</span>
                                        </div>
                                        <hr>
