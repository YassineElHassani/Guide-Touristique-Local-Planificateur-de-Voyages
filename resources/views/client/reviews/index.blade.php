            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0">{{ $reviews->count() > 0 ? number_format($reviews->avg('rating'), 1) : 'N/A' }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0">{{ $reviews->count() > 0 ? $reviews->sortByDesc('created_at')->first()->created_at->format('M d') : 'None' }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="review-item p-4 border-bottom">
                <div class="row">
                    ...
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        ...
                        @if($review->event)
                            <div class="mt-2">
                                <a href="{{ route('events.show', $review->event->id) }}" class="btn btn-sm btn-outline-secondary">
